---
name: lanni-brand
description: "Create and review Lanni branded interfaces, pages, copy and collateral using its identity specifications. Use for Lanni work, not unrelated brands."
---
...
Lanni is built on FireFlow. Preserve coral and the human, clear voice. The L-shaped mark is a proposed extension, and current availability is unverified. Keep proposed actions, review, execution and completion distinguishable.
