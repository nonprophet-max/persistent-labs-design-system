...
- [persistent-labs.svg](../assets/persistent-labs.svg)
- [fireflow.svg](../assets/fireflow.svg)
- [memorytree.svg](../assets/memorytree.svg)
- [unfazed.svg](../assets/unfazed.svg)
- [lanni.svg](../assets/lanni.svg)
- [privateinference.svg](../assets/privateinference.svg)
- [galactica.svg](../assets/galactica.svg)
